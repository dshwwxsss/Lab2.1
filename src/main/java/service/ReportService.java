...
public class ReportService {
    ...
    public ReportService(ReportRepository repository, SampleService sampleService) throws SQLException {
    ...
    public void finalizeReport(long id, String currentUser) throws ValidationException, SQLException {
        ...
        if (!report.getOwnerUsername().equals(currentUser)) throw new ValidationException("Нет прав");
